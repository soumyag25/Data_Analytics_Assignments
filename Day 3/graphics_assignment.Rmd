...
plot(total_NEI$year, total_NEI$Emissions, type = "o", col = "red", main = expression("Total US Emissions vs Year"), ylab = expression("Total US Emissions"), xlab = "Year")
...
plot(total_baltimore_city$year, total_baltimore_city$Emissions, type = "o", main = expression("Total Baltimore Emissions vs Year"), xlab = "Year", ylab = expression("Total Baltimore Emissions"))
```
